...
const IP_SERVICES = [
  ...
  },
  {
    ...
    transform: (data: any): ProcessedIPInfo => ({
      ...
      region: data.location?.state_prov || "Unknown",
      country: data.location?.country_name || "Unknown",
      country_code: data.location?.country_code2 || "Unknown",
      continent_code: data.location?.continent_code || "Unknown",
      ...
      hosting: false,
      accuracy_score: 0.8,
      postal_code: data.location?.zipcode || undefined,
   }),
  },
  {
    name: "iplocation.io",
